const { remote } = require('electron'); // remote nos permite comunicar el render con el proceso main de electron
...
//   }
  ...
  // Inicia cada vez que arranca la aplicacion
  async function init() {
    getProducts();
  }
